...
# todo общие друзья / отправка уведомлений / регистрация - авторизация / фильтрация новостей / лайки под комментарии (модель (пользователь и коммент) сериализатор на добавление лайка и 2 экшена во вьюсете на добавление и удаление, поправить куэрисет )
# разобрать куэрисет
